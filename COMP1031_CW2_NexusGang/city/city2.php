...
<html>
	...
	<body>
		...
		<div class="main">
			<h2>City  <font size="3"> [page:3/5]</font></h2>
			...
			<table class ="citytables"> 
				...
				<?php
				$sql = "SELECT ID, Name, CountryCode, District, Population FROM CITY WHERE ID BETWEEN 2001 AND 3000";
