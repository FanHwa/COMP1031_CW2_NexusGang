...
<html>
	...
	<body>
		...
		<div class="main">
			<h2>City  <font size="3"> [page:4/5]</font></h2>
			...
			<table class = "citytable"> 
				...
				<?php
				$sql = "SELECT ID, Name, CountryCode, District, Population FROM CITY WHERE ID BETWEEN 3001 AND 4000";
