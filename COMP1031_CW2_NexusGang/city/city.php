...
<html>
	...
	<body>
		...
		<div class="main">
			<h2>City  <font size="3"> [page:1/5]</font></h2>
			<!-- Start table -->
			<table class="citytable"> 
				<tr class = "noborder">
					...
					<td></td>
					<td>
						<button onclick="document.getElementById('next').style.display='block'" class="w3-button w3-dark-grey CityOnlyNext">
  							<a href= "city1.php">Next Page</a>
  						</button>
					</td>
				</tr>
				<tr>
				...
				<?php
				$sql = "SELECT ID, Name, CountryCode, District, Population FROM CITY LIMIT 1000";
